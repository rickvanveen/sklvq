...
# from sklvq.activations import Identity, Sigmoid


# @pytest.mark.parametrize(
#     "Identity", [np.array([0, 1, 2]), np.array([0, 1, 2]), np.ones(3, 1)]
# )
# def test_identity(input, expected, expected_gradient):
#     identity = Identity()

#     assert np.all(identity(input) == expected)

#     assert np.all(identity.gradient(input) == expected_gradient)


# @pytest.mark.parametrize(
#     "Sigmoid (0)",
#     [{}, np.array([0]), pytest.approx(0.5), pytest.approx(0.25)],
#     "Sigmoid (0, b>1)",
#     [{"beta": 10}, np.array([0]), pytest.approx(0.5), pytest.approx(0.25)],
# )
# def test_sigmoid_and_gradient(params, input, expected, expected_gradient):
#     sigmoid = Sigmoid(**params)

#     assert np.all(sigmoid(input) == expected)

#     assert np.all(sigmoid.gradient(input) == expected_gradient)
...
# )
# def test_sigmoid(params, input, expected):
#     sigmoid = Sigmoid(**params)
